...
var tests = [ //array of arrays, each inner array contains two statements that are supposed to be equal
  ...
  [prepTextForRender(`<cut>a</cut>b`, 'id', 'preview'), `<button class='text-button special' onclick='$("id-0").classList.remove("removed"); this.classList.add("removed");'><x id='id-1'>a</x><icon class="far fa-plus-square expand-button"></icon></button><innerCut id=id-0 class='removed'><x id='id-2'>b</x></innerCut>`],
  //#10
  ...
  [prepTextForRender(`<u><cut>x</cut><note linkText="a"><note linkText="b">c<br></note><br></note><br>d</u> e`, 'id', 'preview'), `<u><button class='text-button special' onclick='$("id-0").classList.remove("removed"); this.classList.add("removed");'><x id='id-1'>x</x><icon class="far fa-plus-square expand-button"></icon></button><innerCut id=id-0 class='removed'><a href="javascript:void(0);" class="clicky special" id="id-2" onclick="collapseNote('id-2','id-3', true, 'id')"><x id='id-4'>a</x><icon id="id-3-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-3-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-3"><clicky onclick="collapseNote('id-2', 'id-3', false, 'id', true)" class="clicky collapse-button-bottom filter-focus" id="id-3-note-close"><icon class="far fa-minus-square"></icon></clicky><a href="javascript:void(0);" class="clicky special" id="id-5" onclick="collapseNote('id-5','id-6', true, 'id')"><x id='id-7'>b</x><icon id="id-6-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-6-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-6"><clicky onclick="collapseNote('id-5', 'id-6', false, 'id', true)" class="clicky collapse-button-bottom filter-focus" id="id-6-note-close"><icon class="far fa-minus-square"></icon></clicky><x id='id-8'>c</x><br></innerNote><br id="id-6-br"></innerNote><br id="id-3-br"><x id='id-9'>d</x></innerCut></u><x id='id-10'> e</x>`],
