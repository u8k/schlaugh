...
var tests = [ //array of arrays, each inner array contains two statements that are supposed to be equal
  ...
  [prepTextForRender(`a<note linkText="b"></note>c</note>d<br>a<note linkText="b"></note>c</note>d`, 'id', 'preview'), `<x id='id-0'>a</x><a class="clicky special" id="id-1" onclick="collapseNote('id-1','id-2', true)"><x id='id-3'>b</x></a><innerNote class="removed" id="id-2"><clicky onclick="collapseNote('id-1', 'id-2')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-1', 'id-2', false, 'id')" class="collapse-button-bottom hidden" id="id-2-note-close"><icon class="far fa-minus-square"></icon></clicky></innerNote><x id='id-4'>cd</x><br><x id='id-5'>a</x><a class="clicky special" id="id-6" onclick="collapseNote('id-6','id-7', true)"><x id='id-8'>b</x></a><innerNote class="removed" id="id-7"><clicky onclick="collapseNote('id-6', 'id-7')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-6', 'id-7', false, 'id')" class="collapse-button-bottom hidden" id="id-7-note-close"><icon class="far fa-minus-square"></icon></clicky></innerNote><x id='id-9'>cd</x>`],
  // #30
  ...
  // [prepTextForRender(``,`id`,null,{startElem:7, endElem:7, startOffset:1, endOffset:3}), ``],
]
