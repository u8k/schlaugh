...
var tests = [ //array of arrays, each inner array contains two statements that are supposed to be equal
  ...
  [prepTextForRender(`before<br><note linkText="the button">the inner text<br></note><br>after`, 'id', 'preview'), `<x id='id-0'>before</x><br><a class="clicky special" id="id-1" onclick="collapseNote('id-1','id-2', true, 'id')"><x id='id-3'>the button</x><icon id="id-2-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-2-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-2"><clicky onclick="collapseNote('id-1', 'id-2', false, 'id')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-1', 'id-2', false, 'id', true)" class="collapse-button-bottom hidden" id="id-2-note-close"><icon class="far fa-minus-square"></icon></clicky><x id='id-4'>the inner text</x><br></innerNote><br id="id-2-br"><x id='id-5'>after</x>`],
  ...
  [prepTextForRender(`<u><cut>x</cut><note linkText="a"><note linkText="b">c<br></note><br></note><br>d</u> e`, 'id', 'preview'), `<u><cut class='clicky special' onclick='$("id-0").classList.remove("removed"); this.classList.add("removed");'><x id='id-1'>x</x><icon class="far fa-plus-square expand-button"></icon></cut><innerCut id=id-0 class='removed'><a class="clicky special" id="id-2" onclick="collapseNote('id-2','id-3', true, 'id')"><x id='id-4'>a</x><icon id="id-3-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-3-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-3"><clicky onclick="collapseNote('id-2', 'id-3', false, 'id')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-2', 'id-3', false, 'id', true)" class="collapse-button-bottom hidden" id="id-3-note-close"><icon class="far fa-minus-square"></icon></clicky><a class="clicky special" id="id-5" onclick="collapseNote('id-5','id-6', true, 'id')"><x id='id-7'>b</x><icon id="id-6-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-6-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-6"><clicky onclick="collapseNote('id-5', 'id-6', false, 'id')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-5', 'id-6', false, 'id', true)" class="collapse-button-bottom hidden" id="id-6-note-close"><icon class="far fa-minus-square"></icon></clicky><x id='id-8'>c</x><br></innerNote><br id="id-6-br"></innerNote><br id="id-3-br"><x id='id-9'>d</x></innerCut></u><x id='id-10'> e</x>`],
  ...
  [prepTextForRender(`<quote>test<br><r><a href="http://butts.cash">-cite</a><br></r></quote>`, 'id', 'preview'), `<quote><x id='id-0'>test</x><br><r><a class='clicky special ex-link' target="_blank" href="http://butts.cash"><x id='id-1'>-cite</x></a><br></r></quote>`],
]
