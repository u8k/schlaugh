...
var tests = [ //array of arrays, each inner array contains two statements that are supposed to be equal
  ...
  [prepTextForRender(`<cut>a</cut>b`, 'id', 'preview'), `<cut class='clicky special' onclick='$("id-0").classList.remove("removed"); this.classList.add("removed");'><x id='id-1'>a</x></cut><innerCut id=id-0 class='removed'><x id='id-2'>b</x></innerCut>`],
  //#10
