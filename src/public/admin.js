...
var tests = [ //array of arrays, each inner array contains two statements that are supposed to be equal
  ...
  [prepTextForRender("<b>buffalo</b>", 'id', 'preview'), `<b><x id='id-0'>buffalo</x></b>`],
  [prepTextForRender("<u>buffalo <i>itals</i> buffalo <b>bolds</b> buffalo <code>code</code> buffalo <s>strike</s> buffalo</u>", 'id', 'preview'), `<u><x id='id-0'>buffalo </x><i><x id='id-1'>itals</x></i><x id='id-2'> buffalo </x><b><x id='id-3'>bolds</x></b><x id='id-4'> buffalo </x><code><x id='id-5'>code</x></code><x id='id-6'> buffalo </x><s><x id='id-7'>strike</x></s><x id='id-8'> buffalo</x></u>`],
  [prepTextForRender(`before<br><note linkText="the button">the inner text<br></note><br>after`, 'id', 'preview'), `<x id='id-0'>before</x><br><a class="clicky special" id="id-1" onclick="collapseNote('id-1','id-2', true)"><x id='id-3'>the button</x><icon id="id-2-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-2-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-2"><clicky onclick="collapseNote('id-1', 'id-2')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-1', 'id-2', false, 'id')" class="collapse-button-bottom hidden" id="id-2-note-close"><icon class="far fa-minus-square"></icon></clicky><x id='id-4'>the inner text</x><br></innerNote><br id="id-2-br"><x id='id-5'>after</x>`],
  [prepTextForRender(`<cut>a</cut>b`, 'id', 'preview'), `<cut class='clicky special' onclick='$("id-0").classList.remove("removed"); this.classList.add("removed");'><x id='id-1'>a</x><icon class="far fa-plus-square expand-button"></icon></cut><innerCut id=id-0 class='removed'><x id='id-2'>b</x></innerCut>`],
  //#10
  [prepTextForRender(`<ol><li>a</li><ul><li>b</li></ol><li>c</li></ul>`, 'id', 'preview'), `<ol><li><x id='id-0'>a</x></li><ul><li><x id='id-1'>b</x></li></ul></ol><li><x id='id-2'>c</x></li>`],
  [prepTextForRender(`<u><cut>x</cut><note linkText="a"><note linkText="b">c<br></note><br></note><br>d</u> e`, 'id', 'preview'), `<u><cut class='clicky special' onclick='$("id-0").classList.remove("removed"); this.classList.add("removed");'><x id='id-1'>x</x><icon class="far fa-plus-square expand-button"></icon></cut><innerCut id=id-0 class='removed'><a class="clicky special" id="id-2" onclick="collapseNote('id-2','id-3', true)"><x id='id-4'>a</x><icon id="id-3-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-3-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-3"><clicky onclick="collapseNote('id-2', 'id-3')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-2', 'id-3', false, 'id')" class="collapse-button-bottom hidden" id="id-3-note-close"><icon class="far fa-minus-square"></icon></clicky><a class="clicky special" id="id-5" onclick="collapseNote('id-5','id-6', true)"><x id='id-7'>b</x><icon id="id-6-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-6-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-6"><clicky onclick="collapseNote('id-5', 'id-6')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-5', 'id-6', false, 'id')" class="collapse-button-bottom hidden" id="id-6-note-close"><icon class="far fa-minus-square"></icon></clicky><x id='id-8'>c</x><br></innerNote><br id="id-6-br"></innerNote><br id="id-3-br"><x id='id-9'>d</x></innerCut></u><x id='id-10'> e</x>`],
  [prepTextForRender(`a<hr>e`, 'id', 'preview'), `<x id='id-0'>a</x><hr><x id='id-1'>e</x>`],
  [prepTextForRender(`<quote>test<br><r><a href="butts.cash">-cite</a><br></r></quote>`, 'id', 'preview'), `<quote><x id='id-0'>test</x><br><r><a class='clicky special ex-link' target="_blank" href="butts.cash"><x id='id-1'>-cite</x></a><br></r></quote>`],
  ...
  [prepTextForRender(`a<note linkText="b"></note>c</note>d<br>a<note linkText="b"></note>c</note>d`, 'id', 'preview'), `<x id='id-0'>a</x><a class="clicky special" id="id-1" onclick="collapseNote('id-1','id-2', true)"><x id='id-3'>b</x><icon id="id-2-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-2-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-2"><clicky onclick="collapseNote('id-1', 'id-2')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-1', 'id-2', false, 'id')" class="collapse-button-bottom hidden" id="id-2-note-close"><icon class="far fa-minus-square"></icon></clicky></innerNote><x id='id-4'>cd</x><br><x id='id-5'>a</x><a class="clicky special" id="id-6" onclick="collapseNote('id-6','id-7', true)"><x id='id-8'>b</x><icon id="id-7-note-top-plus" class="far fa-plus-square expand-button"></icon><icon id="id-7-note-top-minus" class="far fa-minus-square removed expand-button"></icon></a><innerNote class="removed" id="id-7"><clicky onclick="collapseNote('id-6', 'id-7')" class="collapse-button-top"><icon class="far fa-minus-square"></icon></clicky><clicky onclick="collapseNote('id-6', 'id-7', false, 'id')" class="collapse-button-bottom hidden" id="id-7-note-close"><icon class="far fa-minus-square"></icon></clicky></innerNote><x id='id-9'>cd</x>`],
  // #30
